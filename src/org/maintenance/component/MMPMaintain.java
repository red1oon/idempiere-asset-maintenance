...
public class MMPMaintain extends X_MP_Maintain {
	...
	public MMPMaintain(Properties ctx, int MP_Maintain_ID, String trxName) {
		super(ctx, MP_Maintain_ID, trxName);
		// TODO Auto-generated constructor stub
	}

	public MMPMaintain(Properties ctx, ResultSet rs, String trxName) {
