...
import org.maintenance.model.X_MP_JobStandar_Task;

public class MMPJobStandardTask extends X_MP_JobStandar_Task {
	...
	public MMPJobStandardTask(Properties ctx, int MP_JobStandar_ID,
			String trxName) {
		super(ctx, MP_JobStandar_ID, trxName);
 	}

	public MMPJobStandardTask(Properties ctx, ResultSet rs, String trxName) {
